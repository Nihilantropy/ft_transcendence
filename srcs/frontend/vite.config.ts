...
export default defineConfig(({ mode }) => {
  ...
  const HOST_DOMAIN = env.HOST || 'ft_transcendence.42.crea'
  ...
  return {
    ...
    server: {
      ...
      port: 5173,
      strictPort: true,
      // ✅ FIXED: Allow custom domain access
      allowedHosts: [
        'localhost',
        '127.0.0.1',
        HOST_DOMAIN,
        'ft_transcendence.42.crea'
      ],
      watch: {
      ...
      hmr: {
        ...
        host: HOST_DOMAIN,    // Use custom domain for client connection
      ...
      origin: `https://${HOST_DOMAIN}`, // Match nginx HTTPS origin
    },
